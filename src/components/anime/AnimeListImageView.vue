<template>
  <div class="home-stagger-children space-y-3">
    <div
      ...
      <div class="flex">
        ...
        <div class="w-24 h-24 sm:w-32 sm:h-32 flex-shrink-0 relative">
          ...
          <div v-else class="w-full h-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center">
            <span class="text-white text-2xl font-bold">{{ getAnimeDisplayTitle(anime).charAt(0) }}</span>
          </div>
        </div>
        ...
        <div class="flex-1 p-4 flex flex-col justify-between min-w-0">
          <div>
            ...
            <p v-if="mostrarRevisionInfo(anime)" class="mb-2 text-[11px] font-medium text-indigo-600">
        ...
        <div class="flex items-center space-x-1 p-2">
          <button
            ...
            :aria-label="`Editar anime: ${getAnimeDisplayTitle(anime)}`"
            title="Editar"
          ...
          <button
            ...
            :aria-label="`Eliminar anime: ${getAnimeDisplayTitle(anime)}`"
            title="Eliminar"
...
const mostrarRevisionInfo = (anime) =>
